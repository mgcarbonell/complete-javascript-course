...
if (mark.bmi < john.bmi) {
  console.log(`${john.fullName} has a higher BMI than ${mark.fullName}. ${john.bmi} vs. ${mark.bmi}`)
} else {
  console.log(`${mark.fullName} has a higher BMI than ${john.fullName}. ${mark.bmi} vs. ${john.bmi}`)
}